...
module.exports = async function (socket) {
  ...
  socket.on('get-my-current-version', async (input) => {
    ...
    console.log('get-my-current-version result:', result)
  })
  ...
  socket.on('get-my-upcomming-schedule-list', async (input) => {
    ...
    console.log('get-my-upcomming-schedule-list result:', result)
  })
  ...
  socket.on('get-schedule-by-versionId', async (input) => {
    ...
    console.log('get-schedule-by-versionId result:', result)
  })
  ...
  socket.on('update-current-displaying-version', async (input) => {
    ...
    console.log('update-current-displaying-version result:', result)
  })
